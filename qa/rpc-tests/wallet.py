...
#   c) node1 mines 32 blocks, so now node 0 has 60001SmartGreenCoin, node 1 has 4250SmartGreenCoin, node2 has none.
#   d) node0 sends 601 SmartGreenCoin to node2, in two transactions (301 SmartGreenCoin, then 300 SmartGreenCoin).
