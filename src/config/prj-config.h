/* src/config/SmartGreenCoin-config.h.  Generated from SmartGreenCoin-config.h.in by configure.  */
/* src/config/SmartGreenCoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef SmartGreenCoin_CONFIG_H

#define SmartGreenCoin_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.SmartGreenCoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "SmartGreenCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "SmartGreenCoin Core 1.0.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "SmartGreenCoin"
