...
/** Utility functions used by the SmartGreenCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render SmartGreenCoin addresses in monospace font
...
// Parse "SmartGreenCoin:" URI into recipient object, return true on successful parsing
