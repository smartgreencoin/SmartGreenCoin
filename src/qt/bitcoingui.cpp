...
QFontDatabase::addApplicationFont(":/fonts/SmartGreenCoin_font");

QString windowTitle = tr("SmartGreenCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SmartGreenCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and SmartGreenCoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SmartGreenCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about SmartGreenCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SmartGreenCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SmartGreenCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SmartGreenCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a SmartGreenCoin: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the SmartGreenCoin Core help message to get a list with possible SmartGreenCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SmartGreenCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SmartGreenCoin network", "", count));
}
...
{
    QString strTitle = tr("SmartGreenCoin Core"); // default title
    ...
    // Append title to "SmartGreenCoin - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
