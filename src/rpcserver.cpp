...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop SmartGreenCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "SmartGreenCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SmartGreenCoin features */
        {"SmartGreenCoin", "masternode", &masternode, true, true, false},
        {"SmartGreenCoin", "listmasternodes", &listmasternodes, true, true, false},
        {"SmartGreenCoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"SmartGreenCoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"SmartGreenCoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"SmartGreenCoin", "masternodedebug", &masternodedebug, true, true, false},
        {"SmartGreenCoin", "startmasternode", &startmasternode, true, true, false},
        {"SmartGreenCoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"SmartGreenCoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"SmartGreenCoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"SmartGreenCoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"SmartGreenCoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"SmartGreenCoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"SmartGreenCoin", "mnsync", &mnsync, true, true, false},
        {"SmartGreenCoin", "spork", &spork, true, true, false},
        {"SmartGreenCoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"SmartGreenCoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use SmartGreenCoind, or the -server option to SmartGreenCoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> SmartGreenCoin-cli " + methodname + " " + args + "\n";
}
