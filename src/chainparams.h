 ...
 * SmartGreenCoin system. There are three: the main network on which people trade goods
...
public:
    ...
    // const std::vector<unsigned char>& SmartGreenCoinDevKey() const { return vSmartGreenCoinDevKey; }
    // const std::vector<unsigned char>& SmartGreenCoinFundKey() const { return vSmartGreenCoinFundKey; }
...
protected:
    ...
    // std::vector<unsigned char> vSmartGreenCoinDevKey;
    // std::vector<unsigned char> vSmartGreenCoinFundKey;
    // int nDevFee;
    // int nFundFee;
    int nDefaultPort;
