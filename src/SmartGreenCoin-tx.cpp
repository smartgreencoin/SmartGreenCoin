...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SmartGreenCoin Core SmartGreenCoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  SmartGreenCoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded SmartGreenCoin transaction") + "\n" +
                               "  SmartGreenCoin-tx [options] -create [commands]   " + _("Create hex-encoded SmartGreenCoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded SmartGreenCoin transaction
