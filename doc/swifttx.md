...
* WebSocket: [https://github.com/SmartGreenCoin/insight-api-SmartGreenCoin#web-socket-api](https://github.com/SmartGreenCoin/insight-api-SmartGreenCoin#web-socket-api)
* API: [https://github.com/SmartGreenCoin/insight-api-SmartGreenCoin#swifttx-transactions](https://github.com/SmartGreenCoin/insight-api-SmartGreenCoin#swifttx-transactions)
...
By default, the SmartGreenCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SmartGreenCoin Core daemon:
