...
In order to support loading of multiple wallets in SmartGreenCoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is SmartGreenCoin.cpp.
...
Changes to SmartGreenCoin.cpp
----------------------
SmartGreenCoin.cpp is the entry point into SmartGreenCoin-qt, and as such, will require some minor modifications to provide hooks for
