Contributing to SmartGreenCoin Core
============================

The SmartGreenCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SmartGreenCoin Core project, and is not to be
confused with overall SmartGreenCoin Network Protocol consensus changes.

Whether a pull request is merged into SmartGreenCoin Core rests with the project merge
...
Patches that change SmartGreenCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the SmartGreenCoin consensus, it must have been
...
The project leader is the release manager for each SmartGreenCoin Core release.
